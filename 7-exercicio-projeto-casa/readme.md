...
- Este exercício para casa segue o mesmo fluxo que o exercício da pasta [5-exercicio-projeto-aula](https://github.com/reprograma/On4-git-e-github/blob/master/5-exercicio-projeto-aula/exercicio5.md). Você pode usar a apresentação daquele exercício como referência.
...
* Entrar nesse repositório local
	...
	```
  cd -git-e-github/7-exercicio-projeto-casa
  ```
...
* Verificar se as alterações foram atualizadas na sua branch lá no github (https://github.com/reprograma/On4-git-e-github)
